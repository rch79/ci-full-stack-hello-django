...
# from todo import views  # less versbose way of importing all of the above views

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', get_todo_list, name='get_todo_list'),   # pulling function from app folder (app must be invluded in settings.py file)
